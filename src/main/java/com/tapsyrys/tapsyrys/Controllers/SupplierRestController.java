...
public class SupplierRestController {
    ...
    public ResponseEntity<?> registerSupplier(@RequestBody SupplierResponse supplierResponse) {
        ...
        SupplierResponse response = new SupplierResponse(savedSupplier.getId(), savedSupplier.getName(),savedSupplier.getUsername(),savedSupplier.getPhone(), savedSupplier.getCategory());
    ...
    public List<SupplierResponse> getAll() {
        return supplierRepository.findAll().stream().map(
                supplier -> new SupplierResponse(supplier.getId(), supplier.getName(), supplier.getUsername(), supplier.getPhone(), supplier.getCategory())
        ).toList();
    }
